...
**
** Created: Tue Dec 4 08:08:47 2012
...
static const char qt_meta_stringdata_Option[] = {
    "Option\0\0Option_get_ok(QVariant)\0,\0"
    "Option_get_failed(int,QString)\0"
};

const QMetaObject Option::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Option,
...
int Option::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: Option_get_ok((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        case 1: Option_get_failed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }

...
**
** Created: Tue Dec 4 08:09:08 2012
...
static const char qt_meta_stringdata_Post[] = {
    "Post\0\0Post_get_post_ok(QVariant)\0,\0"
    "Post_get_post_failed(int,QString)\0"
};
...
int Post::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: Post_get_post_ok((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        case 1: Post_get_post_failed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }

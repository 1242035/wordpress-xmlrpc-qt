...
**
** Created: Tue Dec 4 08:08:30 2012
...
static const char qt_meta_stringdata_Media[] = {
    "Media\0\0Media_get_media_ok(QVariant)\0"
    ",\0Media_get_media_failed(int,QString)\0"
};
...
int Media::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: Media_get_media_ok((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        case 1: Media_get_media_failed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }

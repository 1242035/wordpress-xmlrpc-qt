...
**
** Created: Tue Nov 27 23:11:31 2012
...
int xmlrpc::Server::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: incomingRequest((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QList<xmlrpc::Variant>(*)>(_a[3]))); break;
        case 1: sendReturnValue((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const xmlrpc::Variant(*)>(_a[2]))); break;
        case 2: sendFault((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        case 3: newConnection(); break;
        case 4: processRequest((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< QTcpSocket*(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 5;
    }

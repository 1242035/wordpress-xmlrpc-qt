...
**
** Created: Tue Dec 4 08:08:56 2012
...
static const char qt_meta_stringdata_Page[] = {
    "Page\0\0Page_map_from_result()\0"
    "Page_map_from_error()\0"
};

const QMetaObject Page::staticMetaObject = {
    { &Wordpress::staticMetaObject, qt_meta_stringdata_Page,
      qt_meta_data_Page, 0 }
};
...
void *Page::qt_metacast(const char *_clname)
{
    ...
    return Wordpress::qt_metacast(_clname);
}

int Page::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Wordpress::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: Page_map_from_result(); break;
        case 1: Page_map_from_error(); break;
        default: ;
        }
        _id -= 2;
    }

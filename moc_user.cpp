...
**
** Created: Tue Dec 4 08:09:52 2012
...
static const char qt_meta_stringdata_User[] = {
    "User\0\0User_get_users_ok(QVariant)\0,\0"
    "User_get_users_failed(int,QString)\0"
};
...
int User::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: User_get_users_ok((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        case 1: User_get_users_failed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }
